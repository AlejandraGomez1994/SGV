  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <a href="?listarmascota">Listar Mascotas</a>&nbsp // Busqueda por Especie Mascota
          <!-- Topbar Navbar -->
       ...
       <div class="bg-agile">
           <div class="book-appointment">
               <form tipocita="index.php" method="post">
                   <div class="container">
                  <div class="gaps">
                  <p>Ingresar la especie de la mascota</p>
                  <input type="text" class="form-control"  name="inputBuscarEspecie" required>
            </div>
                      
            </div>
            <div class="clear"></div>
						  <input type="submit" name="btnBuscarEspecie" value="Buscar">
            </form>
            </div>
            </div>
