  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="bg-agile">
           <div class="book-appointment">
               ...
               <form action="?tipocita&tipo_cita=<?php echo $idEspecialidad;?>&id_cliente=<?php echo $_GET['id_cliente']?>&nom_mascota=<?php echo $_GET['nom_mascota']?>" method="post">
                   <div class="container">
                   <div id="resultados_ajax" class="gaps"></div>
			             <div class="left-agileits-w3layouts same">
                  <div class="gaps">
                  <p>Profesional:</p>
                  <select class="form-control" name="inputProfesional" style="whidth:255px" required>
                  <option></option>
                  <?php foreach ($empleados as $empleado) { ?>
              <option><?php $idEmpleado=$empleado->getIdEmpleado(); $nomEmpleado=$empleado->getNombre(); echo "$idEmpleado - $nomEmpleado" ?></option>
             <?php 
             }
              ?>  
            </select>
           ...
           <div class="gaps">
			    	<p>Fecha:</p>
					<input type="date" name="inputFecha" placeholder="" min="<?php $fecha=Citas::FechaActual(); echo $fecha;?>" required />
		     	</div>	
                      
            </div>
            <div class="clear"></div>
						  <input type="submit" name="btnProfesional" value="Continuar">
            </form>
            </div>
            </div>
      ...
      <footer class="sticky-footer bg-white">
        ...
        <p style="color:black">&copy; 2019. Agenda-Citas . Mundo Animal Pet Care </p>
     </div>
      </footer>
      <!-- End of Footer -->
