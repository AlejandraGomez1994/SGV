  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <a href="?listarmascota">Listar Mascotas</a>&nbsp // Busqueda por genero mascota
          <!-- Topbar Navbar -->
       ...
       <div class="bg-agile">
           <div class="book-appointment">
               <form tipocita="index.php" method="post">
                   <div class="container">
                  <div class="gaps">
                  <p>Ingresar el genero de la mascota</p>
                  <input type="text" class="form-control"  name="inputBuscarGenero" required>
            </div>
                      
            </div>
            <div class="clear"></div>
						  <input type="submit" name="btnBuscarGenero" value="Buscar">
            </form>
            </div>
            </div>
