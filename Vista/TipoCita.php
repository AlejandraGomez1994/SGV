       ...
       <div class="bg-agile">
           <div class="book-appointment">
               ...
               <form tipocita="index.php" method="post">
                   <div class="container">
                  <div class="gaps">
                  <p style="color:white"> Por favor elija el tipo de cita:</p>
                  <select class="form-control" name="inputTipoCita" style="whidth:255px" required>
                  <option></option>
                  <?php foreach ($tipocita as $cita) {?>
                  <option><?php echo $cita->getDescripcion(); ?></option>
                  <?php
                  }
                  ?>
            </select>
            ...
            <div class="clear"></div>
						  <input type="submit" name="btnTipoCita" value="Continuar">
            </form>
            </div>
            </div>
