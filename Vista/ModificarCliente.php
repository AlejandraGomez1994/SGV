    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <a>Formulario Modificar Clientes</a>
...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
	...
	<h2>Datos Generales del Cliente</h2>
      ...
      <div class="gaps">
					<p>Nombre(s)</p>
					<input type="text" name="inputNomCliente" placeholder="" required="" value="<?php echo $listaCliente->getNomCliente(); ?>"/>
			</div>
      <div class="gaps">
				  <p>Identificación</p>
			...
			<div class="gaps">	
					<p>Número fijo</p>
					<input type="text" name="inputNumero" placeholder="" required="" value="<?php echo $listaCliente->getTelefono(); ?>" />
			</div>
			<div class="gaps">	
					<p>Municipio</p>
					<input type="text" name="inputMunicipio" placeholder="" required="" value="<?php echo $listaCliente->getMunicipio(); ?>"/>
			</div>
		</div>
		...
		<div class="right-agileinfo same">
			<div class="gaps">
					<p>Apellidos</p>
					<input type="text" name="inputApellidos" placeholder="" required="" value="<?php echo $listaCliente->getApellido(); ?>"/>
			</div>	
			<div class="gaps">
			  	<p>E-mail</p>
					<input type="email" name="inputEmail" placeholder="" required="" value="<?php echo $listaCliente->getEmail(); ?>"/>
			</div>
      <div class="gaps">	
					<p>Celular</p>
					<input type="text" name="inputCelular" placeholder="" required="" value="<?php echo $listaCliente->getCelular(); ?>" />
			</div>
			<div class="gaps">	
					<p>Direccion</p>
					<input type="text" name="InputDireccion" placeholder="" required="" value="<?php echo $listaCliente->getDireccion(); ?>"/>
		  </div>
		</div>
			<!--<div class=""></div>-->
