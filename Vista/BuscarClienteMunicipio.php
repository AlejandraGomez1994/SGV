  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <a href="?listarcliente">Listar Clientes</a>&nbsp // Buscqueda por municipio
          <!-- Topbar Navbar -->
       ...
       <div class="bg-agile">
           <div class="book-appointment">
               <form tipocita="index.php" method="post">
                   <div class="container">
                  <div class="gaps">
                  <p>Ingresar el municipio que desea buscar</p>
                  <input type="text" class="form-control"  name="inputBuscarMunicipio" required>
            </div>
                      
            </div>
            <div class="clear"></div>
						  <input type="submit" name="btnBuscarMunicipio" value="Buscar">
            </form>
            </div>
            </div>
