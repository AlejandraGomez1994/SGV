  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <a href="?listarmascota">Listar Mascotas</a>&nbsp // Busqueda por tiempo edad
          <!-- Topbar Navbar -->
       ...
       <div class="bg-agile">
           <div class="book-appointment">
               <form tipocita="index.php" method="post">
                   <div class="container">
                  <div class="gaps">
                  <p>Seleccione un elemento por el que desee filtrar</p>
                  <select class="form-control" name="inputBuscarTiempo" style="whidth:255px">
                  <option></option>
                  <?php foreach ($tiempo as $tiempo) {?>
                  <option><?php echo $tiempo->getDescripcion();?></option>
                  <?php
                  }
                  ?>
            </select>
            ...
            <div class="clear"></div>
						  <input type="submit" name="btnBuscarTiempo" value="Buscar">
            </form>
            </div>
            </div>
