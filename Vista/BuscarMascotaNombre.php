    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <a href="?listarmascota">Listar Mascotas // </a>
          <!-- Topbar Navbar -->
...
<thead>
  <tr>
    ...
    <th scope="col">Agregar Historia Clínica</th>
...
{ 
	?>
<tr>
<td><?php echo $mascota->getNomCliente() ?>
	</td>
    <td><?php echo $mascota->getNomMascota(); ?>
    </td>
    <td><?php echo $mascota->getEdad(); ?>
    </td>
    <td><?php echo $mascota->getTiempo(); ?></td>
    <td><?php echo $mascota->getRaza(); ?>
    </td>
    <td><?php echo $mascota->getEspecie(); ?>
    </td>
