	...
	<h2>Datos Generales de la Mascota</h2>
			...
			<div class="gaps">
				<p>Nombre de la mascota</p>
					<input type="text" name="inputNomMascota" placeholder="" required="" maxlength="20"/>
			</div>
			<br>
			<div class="gaps">
						<p>Especie</p>
...
<div class="gaps">
          ...
          <div class="form-group col-md-4">
              <p>Edad</p>
              <input type="text" name="inputedad" placeholder="" required="" onKeypress="if (event.keyCode < 47 || event.keyCode > 57 ) event.returnValue = false;" min="0" maxlength="2"/>
          </div>
          ...
          <option></option>
            ...
            <div class="gaps">
						<p>Características del pelaje</p>
							<input type="text" name="inputPelaje" maxlength="30" required=""/>
						</div>
            </div>
			<div class="clear"></div>
