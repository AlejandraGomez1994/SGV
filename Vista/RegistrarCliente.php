  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <a>Formulario Registro Clientes</a>
          <!-- Topbar Navbar -->
...
<!--<h1 style="color:black"></h1>-->
	...
	<h2>Datos Generales del Cliente</h2>
			...
			<form registrarcliente="index.php" method="POST">
			<!--<div id="resultados_ajax" class="gaps"></div>-->
			<div class="left-agileits-w3layouts same">
					<div class="gaps">
							<p>Nombre(s)</p>
								<input type="text" name="inputNomCliente" placeholder="" required=""/>
						</div>	
			<div class="gaps">
				<p>Identificación</p>
					<input type="text" name="inputIdentificacion" placeholder="" required="" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="15"/>
			</div>
      <div class="gaps">	
							<p>Municipio</p>
								<input type="text" name="inputMunicipio" placeholder="" required=""/>
							</div>
			<div class="gaps">	
					<p>Número fijo</p>
						<input type="text" name="inputNumero" placeholder="" required=""/>
					</div>
			...
			<div class="right-agileinfo same">
					<div class="gaps">
							<p>Apellidos</p>
								<input type="text" name="inputApellido" placeholder="" required=""/>
						</div>	
            ...
            <div class="gaps">	
					<p>Celular</p>
						<input type="text" name="inputCelular" placeholder="" required=""/>
					</div>

			
			</div>
			<!--<div class=""></div>-->
						  <input type="submit" name="btnRegistrarCliente" value="Registrar Cliente">
						  <br>
