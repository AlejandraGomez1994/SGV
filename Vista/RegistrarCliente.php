...
<body  background="img/img_0.jpg" id="fuente1">
...
<!--<h1 style="color:black"></h1>-->
	...
	<h2>Datos Generales del Cliente</h2>
			...
			<div class="left-agileits-w3layouts same">
					<div class="gaps">
							<p>Nombre(s)</p>
								<input type="text" name="inputNomCliente" placeholder="" required="" maxlength="30"/>
						</div>	
			<div class="gaps">
				<p>Identificación</p>
					<input type="text" name="inputIdentificacion" placeholder="" required="" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="15" minlength="7"/>
			</div>
      <div class="gaps">	
							<p>Municipio</p>
								<input type="text" name="inputMunicipio" placeholder="" required="" maxlength="15"/>
							</div>
			<div class="gaps">	
					<p>Número fijo</p>
						<input type="text" name="inputNumero" placeholder="" required="" maxlength="25"/>
					</div>
			...
			<div class="right-agileinfo same">
					<div class="gaps">
							<p>Apellidos</p>
								<input type="text" name="inputApellido" placeholder="" required="" maxlength="30"/>
						</div>	

			
				<div class="gaps">
				<p>E-mail</p>
						<input type="email" name="inputEmail" placeholder="" required="" maxlength="50" />
				</div>
				<div class="gaps">	
						<p>Direccion</p>
							<input type="text" name="InputDireccion" placeholder="" required="" maxlength="50" />
						</div>
            <div class="gaps">	
					<p>Celular</p>
						<input type="text" name="inputCelular" placeholder="" required="" maxlength="25" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" />
					</div>
