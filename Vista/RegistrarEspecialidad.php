...
<!-- Nav Item - Dashboard -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <a>Formulario Registro Tiempo</a>
          <!-- Topbar Navbar -->
...
<div class="bg-agile">
  ...
  <form registrarespecialidad="index.php" method="POST">
          ...
          <div class="gaps">
            <input class="form-control" type="text" name="inputEspecialidad" required /> 
          </div>
				</div>
      

					<div class="clear"></div>
					<input type="submit" name="btnRegistrarEspecialidad" value="Registrar">
