  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <a>Formulario 2 registro Consulta historia clínica</a>
          <!-- Topbar Navbar -->
...
<div class="bg-agile">
  ...
  <form action="?listarconsulta&id_cliente=<?php echo $_GET['id_cliente'] ?>&nom_mascota=<?php echo $_GET['nom_mascota'] ?>" method="POST">
			...
			<div class="gaps">
						<p>Fecha:</p>
            <input type="date" name="inputFecha" value="<?php $fecha=Citas::FechaActual(); echo $fecha;?>" readonly /> 
				</div>
			...
			<div class="gaps">
                  <p>Profesional</p>
                  <select class="form-control" name="inputProfesional" style="whidth:255px">
                  <option></option>
                  <?php foreach ($Empleado as $empleado) { ?>
              <option value="<?php $idEmpleado=$empleado->getIdEmpleado(); echo "$idEmpleado"?>"><?php $nomEmpleado=$empleado->getNombre(); echo "$nomEmpleado" ?></option>
             <?php 
             }
              ?>  
            </select>
            ...
            <div class="gaps">
							...
							<input type="text" class="form-control" name="inputProcedimiento" id="" placeholder="" > 
						</div>
